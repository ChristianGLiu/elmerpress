 ...
 * @author David Liu
 */
public class RefSouceOnly extends javax.swing.JFrame {
 ...
 String tempName = jTextField10.getText().trim();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (evt.getSource() == jButton9) {
            int returnVal = fc.showOpenDialog(RefSouceOnly.this);
...
jProgressBar1.setStringPainted(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (evt.getSource() == jButton2) {
            ...
            RefSouceOnlyMain.ta = jTextArea1;
            RefDiviedMain.cleanArrs();
            RefSouceOnlyMain.cleanArrs();
            Main.cleanArrs();
            RefSouceOnlyMain.init(fileName);
            try {
                RefSouceOnlyMain.generateXML(RefSouceOnlyMain.finalXMLString, jTextField2.getText());
...
private void initMagzineParams(String a) {
    if(a.contains("Clinical Medicine Research")) {
        RefSouceOnlyMain.magzineShortTitle = "J Clin Med Res";
        RefSouceOnlyMain.magzineTitle = "Journal of Clinical Medicine Research";
        RefSouceOnlyMain.issn_epub = "1918-3011";
        RefSouceOnlyMain.issn_ppub = "1918-3003";
        
    } else if(a.contains("International Journal of Clinical Pediatrics")) {
        RefSouceOnlyMain.magzineShortTitle = "Int J Clin Pediatr";
        RefSouceOnlyMain.magzineTitle = "International Journal of Clinical Pediatrics";
        RefSouceOnlyMain.issn_epub = "1927-1263";
        RefSouceOnlyMain.issn_ppub = "1927-1255";

    } else if(a.contains("Journal of Clinical Gynecology and Obstetrics")) {
        RefSouceOnlyMain.magzineShortTitle = "J Clin Gynecol Obstet";
        RefSouceOnlyMain.magzineTitle = "Journal of Clinical Gynecology and Obstetrics";
        RefSouceOnlyMain.issn_epub = "1927-128X";
        RefSouceOnlyMain.issn_ppub = "1927-1271";

    } else if(a.contains("World Journal of Nephrology and Urology")) {
        RefSouceOnlyMain.magzineShortTitle = "World J Nephrol Urol";
        RefSouceOnlyMain.magzineTitle = "World Journal of Nephrology and Urology";
        RefSouceOnlyMain.issn_epub = "1927-1247";
        RefSouceOnlyMain.issn_ppub = "1927-1239";

    } else if(a.contains("Journal of Current Surgery")) {
        RefSouceOnlyMain.magzineShortTitle = "J Curr Surg";
        RefSouceOnlyMain.magzineTitle = "Journal of Current Surgery";
        RefSouceOnlyMain.issn_epub = "1927-1301";
        RefSouceOnlyMain.issn_ppub = "1927-1298";

    } else if(a.contains("Journal of Hematology")) {
        RefSouceOnlyMain.magzineShortTitle = "J Hematol";
        RefSouceOnlyMain.magzineTitle = "Journal of Hematology";
        RefSouceOnlyMain.issn_epub = "1927-1220";
        RefSouceOnlyMain.issn_ppub = "1927-1212";

    } else if(a.contains("Journal of Endocrinology and Metabolism")) {
        RefSouceOnlyMain.magzineShortTitle = "J Endocrinol Metab";
        RefSouceOnlyMain.magzineTitle = "Journal of Endocrinology and Metabolism";
        RefSouceOnlyMain.issn_epub = "1923-287X";
        RefSouceOnlyMain.issn_ppub = "1923-2861";

    } else if(a.contains("Journal of Neurology Research")) {
        RefSouceOnlyMain.magzineShortTitle = "J Neurol Res";
        RefSouceOnlyMain.magzineTitle = "Journal of Neurology Research";
        RefSouceOnlyMain.issn_epub = "1923-2853";
        RefSouceOnlyMain.issn_ppub = "1923-2845";

    } else if(a.contains("Cardiology Research")) {
        RefSouceOnlyMain.magzineShortTitle = "Cardiol Res";
        RefSouceOnlyMain.magzineTitle = "Cardiology Research";
        RefSouceOnlyMain.issn_epub = "1923-2837";
        RefSouceOnlyMain.issn_ppub = "1923-2829";

    } else if(a.contains("Journal of Medical Cases")) {
        RefSouceOnlyMain.magzineShortTitle = "J Med Cases";
        RefSouceOnlyMain.magzineTitle = "Journal of Medical Cases";
        RefSouceOnlyMain.issn_epub = "1923-4163";
        RefSouceOnlyMain.issn_ppub = "1923-4155";

    } else if(a.contains("World Journal of Oncology")) {
        RefSouceOnlyMain.magzineShortTitle = "World J Oncol";
        RefSouceOnlyMain.magzineTitle = "World Journal of Oncology";
        RefSouceOnlyMain.issn_epub = "1920-454X";
        RefSouceOnlyMain.issn_ppub = "1920-4531";

    } else if(a.contains("Gastroenterology Research")) {
        RefSouceOnlyMain.magzineShortTitle = "Gastroenterol Resa";
        RefSouceOnlyMain.magzineTitle = "Gastroenterology Research";
        RefSouceOnlyMain.issn_epub = "1918-2813";
        RefSouceOnlyMain.issn_ppub = "1918-2805";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new RefSouceOnly().setVisible(true);
            }
        });
    }
